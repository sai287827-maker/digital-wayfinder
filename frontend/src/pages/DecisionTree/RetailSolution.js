            ...
            <div className="retail-solutions-grid">
              {loading ? (
                ...
                >
                  ...
                  <div className="retail-solution-body">
                    <div className="retail-solution-logo-container">
                      {solution.platformImageUrl && (
                        <img
                          src={solution.platformImageUrl}
                          alt={solution.platformName || solution.name}
                          className="retail-solution-logo"
                        />
                      )}
                      {!solution.platformImageUrl && (
                        <span className="retail-solution-name">{solution.platformName || solution.name}</span>
                      )}
                    </div>
                  </div>
                </div>
