...
import './RetailNonFunctionalScope.css';
import { apiGet, apiPost } from '../../api';
import RetailDecisionCriteria from './RetailDecisionCriteria.js';

const RetailNonFunctionalScope = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setError(null);
      try {
        const data = await apiGet('api/decision-tree/non-functional-scope/retail/all');
        setNonFunctionalScopeData(data);
      } catch (err) {
        setError('Failed to fetch retail non-functional scope data.');
      } finally {
        setLoading(false);
      }
    }
  ...
  const handlePrevious = () => {
    navigate('/decision-tree/retail-functional-scope');
  };
  ...
  return (
    <div className="retail-non-functional-scope-container">
      {/* Breadcrumb */}
      <div className="breadcrumb">
        <div className="breadcrumb-content">
          ...
          <span>›</span>
          <span className="breadcrumb-current">Retail Non Functional Scope</span>
        </div>
      </div>
      ...
      <div className="main-layout">
        ...
        <div className="left-sidebar">
          ...
          <p className="sidebar-description">
            Specialized framework for selecting retail-specific non-functional requirements,
        ...
        <div className="main-content">
          ...
          <div className="content-header">
            ...
            {/* COMMENTED OUT - Select Parameters Button */}
            {/*
...
export default RetailNonFunctionalScope;