...
const Operational = () => {
  ...
  useEffect(() => {
    async function fetchQuestions() {
      ...
      setError(null);
      try {
        const response = await apiGet('api/digital-wayfinder/questionaire/operational-innovations/get-questions');
  ...
  const handleSaveAndProceed = async () => {
    try {
      ...
      const response = await apiPost('api/digital-wayfinder/questionaire/operational-innovations/save-answers', payload);
