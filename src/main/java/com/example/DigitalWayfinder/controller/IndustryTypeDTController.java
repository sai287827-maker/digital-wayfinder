...
import com.example.DigitalWayfinder.service.IndustryTypeDTService;
import com.example.DigitalWayfinder.service.SubFunctionalAreaDTService;
...
@RestController
@RequestMapping("/api/decision-tree/industry-type")
@Slf4j
@Service
@RequiredArgsConstructor
@Tag(name = "Decision Tree", description = "APIs for managing decision tree industry type selection")
public class IndustryTypeDTController {
    
    private final IndustryTypeDTService industryTypeService;
    private final SubFunctionalAreaDTService subFunctionalAreaService;
