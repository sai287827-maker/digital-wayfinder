...
@Slf4j
public class IndustryTypeDTService {
    ...
    private IndustryTypeResponseDTO updateExistingRecord(FunctionalAreaDT functionalArea, String industryType) {
        ...
        private IndustryTypeResponseDTO mapToResponseDTO(FunctionalAreaDT functionalArea) {
        return IndustryTypeResponseDTO.builder()
